...
Also, source code for these projects are all in my github profile. Go figure!
...
We also went to Cebu for Devcon, together with my coworker around the Philippines and from Australia. Some of them would travel more than 12 hours just to get into Cebu.
